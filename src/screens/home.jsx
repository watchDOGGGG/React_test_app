				...
				<div className='bg-[#F5F5F5]'>
					<div className='home-section-2 flex flex-row justify-center w-full'>
						<div className='flex flex-col w-[80%]'>
							...
							<div className='mt-[20px] grid grid-cols-4 gap-16 justify-start'>
					...
					<div className='home-section-3 flex flex-row justify-center w-full'>
						<div className='flex flex-col w-[80%]'>
							...
							<div className='mt-[20px] grid grid-cols-4 gap-16'>
					...
					<div className='home-section-4 flex flex-row justify-center w-full mb-[256px]'>
						<div className='flex flex-col w-[80%]'>
							...
							<div className='mt-5 grid grid-cols-4 gap-16 p-16 items-center justify-center'>
								{products
									?.slice(0, 4)
									.reverse()
									.map((items, value) => (
